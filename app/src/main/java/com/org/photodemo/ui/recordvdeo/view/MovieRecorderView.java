package com.org.photodemo.ui.recordvdeo.view;
...
public class MovieRecorderView extends LinearLayout implements MediaRecorder.OnErrorListener {
    ...
    public MovieRecorderView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mWidth = a.getInteger(R.styleable.MovieRecorderView_recorder_width, 320);// 默认320
        mHeight = a.getInteger(R.styleable.MovieRecorderView_recorder_height, 240);// 默认240
    ...
    private void createRecordDir() {
        ...
        try {
            ...
            Log.e("log", TAG + ":" + mVecordFile.getAbsolutePath());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
