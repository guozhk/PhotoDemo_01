...
public class FileUtil {
    private static final String RootFolder = "PhotoDemo";
    ...
    public static String getImageFolder() {
        String temp = getCacheFolder() + File.separator + ImageFolder;
        File file = new File(temp);
        if (!file.exists()) {
            file.mkdir();
        }
    ...
    public static String getCacheFolder() {
        String temp = getRootFolder() + File.separator + CacheFolder;
        File file = new File(temp);
        if (!file.exists()) {
            file.mkdir();
        }
